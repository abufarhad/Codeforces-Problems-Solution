...
/*
#include<stdio.h>
int main(){ long long  a,n; scanf("%d" ,&a);
while(a--) { scanf("%lld" ,&n);  printf("%lld\n",n);  }}
*/
///or,

    ll m,n,t,a,b,c,d,i,j,k,x,y,ans;
    scl(t);
    ...
    ll even= (n*(2*(2*d) +(n-1)*2 ))/2;        ///formula (n*(2*a +(n-1)*2 ))/2;   a=initial num
    ll odd =(n*(2*(2*d-1) +(n-1)*2 ))/2;
